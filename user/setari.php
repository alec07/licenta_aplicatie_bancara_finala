...
<div class="flex flex-col w-screen h-screen overflow-auto text-gray-700">
    <div class="p-4 sm:ml-64">
        ...
        <div class="text-center">
            <h1 class="text-2xl text-slate-600 mb-10">
                Schimbă parola
            </h1>
        </div>
        <div class="text-center ">
            <form method="POST" action="includes/schimbare_parola.inc.php" class="mb-4">
                <div class="mb-5">
                    ...
                    <input type="password" id="parolaVeche" name="parolaVeche"
                        class="border border-gray-300 rounded px-3 py-2" require>
                </div>
                <div class="mb-5">
                    <label for="parolaNoua" class="mr-2">Parola nouă:</label>
                    <input type="password" id="parolaNoua" name="parolaNoua"
                        class="border border-gray-300 rounded px-3 py-2" require>
                    <input type="checkbox" id="afiseazaParola"> Afișare parolă
                </div>
                <div class="mb-5">
...
<script>
const afiseazaParolaCheckbox = document.getElementById('afiseazaParola');
const parolaInput = document.getElementById('parolaNoua');


afiseazaParolaCheckbox.addEventListener('change', function() {
    if (this.checked) {
