                    ...
                    <?php
                        ...
                        if ($id_pagina) {
                            ...
                            foreach ($related_tables as $table_name) {
                                ...
                                // Verificam dacă există înregistrări în rezultat
                                if ($result->num_rows > 0) {
                                    $row = $result->fetch_assoc();

                                    echo "<label for='h1_text'>Titlul paginii:</label>";
                                    echo "<input type='text' name='h1_text' value='".$row['h1_text']."' class='border border-gray-300 rounded p-2 mb-2 w-full'><br><br>";

                                    echo "<label for='h2_text'>Textul pentru conținutul paginii:</label>";
