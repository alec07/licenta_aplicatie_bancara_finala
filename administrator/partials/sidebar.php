<aside id="separator-sidebar"
    class="  fixed justify-center items-center top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 "
    aria-label="Sidebar">
    <div
        class="space-y-3 justify-between h-full px-3 py-4 bg-slate-100 opacity-100 dark:bg-slate-900 text-slate-500 dark:text-slate-400">
        ...
        <h3 class="text-slate-500 opacity-100  font-bold">User Management</h3>
        <ul class="flex-col space-y-3 ">
            ...
            <li class="transition-colors duration-300 hover:bg-indigo-100 opacity-100  rounded-lg ">
                <a href="inregistrare-client.php"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Inregistreaza un client</span>
                </a>
            </li>
        ...
        <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li class="transition-colors duration-300 hover:bg-indigo-100 opacity-100  rounded-lg ">
                <a href="raport_plati.php"
                    ...
                    <span class="ml-4">Plati facturi</span>
                </a>
            </li>
        ...
        <div class="w-full h-20 px-6 font-bold">
            <h1 class="text-2xl text-slate-700 opacity-100  font-bold text-center justify-center ">B A N K</h1>
        </div>
    </div>
    </div>
</aside>
